...
var SQSLocal = /** @class */ (function () {
    function SQSLocal(options) {
        ...
        this.version = '0.14.6';
        this.jarname = "elasticmq-server-".concat(this.version, ".jar");
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, new Promise(function (resolve, reject) {
                                ...
                                if (verbose) {
                                    debug("SQSLocal(".concat(child.pid, ") started via java ").concat(args.join(' '), " from CWD ").concat(installPath));
                                }
                                resolve(child);
                            })];
                }
                    ...
                    return [2 /*return*/, new Promise(function (resolve, reject) {
                            https
                                ...
                                if (200 != res.statusCode) {
                                    reject(new Error("Error getting ".concat(res.headers['location'], ": ").concat(res.statusCode)));
                                }
                                res.pipe(dest);
                                res
                                    .on('data', function () {
